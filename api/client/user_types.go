...
type element struct {
	...
	Score *uint64 `form:"score,omitempty" json:"score,omitempty" xml:"score,omitempty"`
...
type multiElement struct {
	// IDs of elements
	ElementIds []uint64 `form:"element_ids,omitempty" json:"element_ids,omitempty" xml:"element_ids,omitempty"`
}
...
type multiListBackup struct {
	Destination *backupDestination `form:"destination,omitempty" json:"destination,omitempty" xml:"destination,omitempty"`
	Lists       *listQL            `form:"lists,omitempty" json:"lists,omitempty" xml:"lists,omitempty"`
}
...
type rankList struct {
	...
	LoadIndex *bool `form:"load_index,omitempty" json:"load_index,omitempty" xml:"load_index,omitempty"`
	// Merge adjacent Segments with less than this number of entries
	MergeSize *int `form:"merge_size,omitempty" json:"merge_size,omitempty" xml:"merge_size,omitempty"`
	...
	SplitSize *int `form:"split_size,omitempty" json:"split_size,omitempty" xml:"split_size,omitempty"`
}
